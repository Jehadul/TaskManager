...
public class CheckBox extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		str += "<input class=\"" + this.getName() + "\" type=\"hidden\"  name=\"ch_" + this.getName() + "\"";
		...
		str += "<script>";
		str += "InitHandlers(); ";
		str += "$(\"#" + this.getName() + "\").on(\"click\",function(){";
		str += "if( $(\"#" + this.getName() + "\").prop(\"checked\") == true){";
		str += "$(\"." + this.getName() + "\").val(\"true\");";
		str += "}else{";
		str += "$(\"." + this.getName() + "\").val(\"false\");}});";
		str += "</script>";
		str += "</div>";
