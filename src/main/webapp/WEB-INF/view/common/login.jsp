			...
			<div class="box-login">
				...
				<form name='loginForm'
					...
					<fieldset>
						...
						<div class="form-group">
							<span class="input-icon"> <input id="username" type="text"
								class="form-control" name="username" placeholder="Username">
								<i class="fa fa-user"></i>
							</span>
						</div>
						<div class="form-group form-actions">
							<span class="input-icon"> <input id="password"
						...
						<div class="forgot-password">
							Forgot your password? <a href="login_forgot.html"> Request
								reset </a>
						</div>
					</fieldset>
					<input type="hidden" name="${_csrf.parameterName}"
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span
						class="text-bold text-uppercase"> CTrends </span>. <span>All
