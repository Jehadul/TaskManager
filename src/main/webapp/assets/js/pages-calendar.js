var Calendar = function() {"use strict";
	...
	var runFullCalendar = function() {
		$(".add-event").off().on("click", function() {    /*add-event class for Add New Event button*/
	...
	var eventInputDateHandler = function() {
		var startInput = $('#start-date-time');    /*https://fullcalendar.io/docs/timeline/dayClick/
...
/*1.setFullCalendarEvents   -> show event of full calendar
2.runFullCalendar           -> function to initiate Full Calendar -> add-event class for Add New Event button
3.runFullCalendarValidation  
4.eventInputDateHandler*/
